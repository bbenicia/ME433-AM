...
int main() {
    ...
    //char m[100]; // char array for uart data coming in
  
    int w [12] = { 0, 30, 60 , 90, 120 , 150 , 180 , 210 , 240 ,270 ,300 , 330};
    //int w [23] = { 0,15, 30,45, 60 ,75, 90,105, 120 ,135, 150 ,165, 180 ,195, 210 ,225, 240 ,255,270 ,285,300 ,315, 330};
...
//        for (int i=0 ; i < 9 ; i++ ) { 
            for (int j=0 ; j < 4 ; j++ ) { 
                c[j] = HSBtoRGB(w[(i + j) % 12] , 1 , 0.5);  // 0 to 360 , 0 to 100 ,0 to 100 
               // c[j] = HSBtoRGB((i + (j + j * 20)) % 360, 1 , 0.5);  //GLOW VERSION 
               
            }
        
        i++ ;
//        if ( i >= sizeof(w)) { // previosly 8 
//            i =0 ; 
//         }
//        
        //GLOW VERSION 
